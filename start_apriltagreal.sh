...
# ./start_apriltagreal.sh True Left
#			  true to also run rviz, slam, nav2
#				Left assume ucf left or artermis, right assume ucf right arena
...
if [ "$2" = "Left" ]; then
	...
	gnome-terminal -x  $SHELL -ic "conda deactivate; ros2 launch fiducial_tb3_gazebo_demo sim_mapping_anchor_rightside.launch.py apriltag_cfg:=apriltag_20.yaml;bash"
fi
