#!/bin/bash
gnome-terminal -x  $SHELL -ic "cd ~/; ros2 bag play msbuild/ --clock -r 0.5; bash"
gnome-terminal -x  $SHELL -ic "ros2 launch point_lio mapping_velody16.launch.py use_sim_time:=true; bash"
gnome-terminal -x  $SHELL -ic "rviz2 -d ~/ros2_ws_nasa/ws_pointlio/src/pointlio_tf_bridge/scan.rviz; bash"
...
gnome-terminal -x  $SHELL -ic "ros2 launch slam_toolbox online_async_launch.py   slam_params_file:=/home/robot/slam_async_pointlio.yaml; bash"
