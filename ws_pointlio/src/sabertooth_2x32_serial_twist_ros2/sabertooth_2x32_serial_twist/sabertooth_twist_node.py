...
class SabertoothTwistNode(Node):
    def __init__(self) -> None:
        super().__init__('sabertooth_2x32_serial_twist')
        ...
        self.declare_parameter('motor_power_topic', '/motor_power')
        ...
        self._motor_power_topic = self.get_parameter('motor_power_topic').value
        ...
        self.get_logger().info(
            ...
            f'(address={cfg.address}). Listening on {self._cmd_vel_topic} and {self._motor_power_topic}.'
        )

        self.create_subscription(Twist, self._cmd_vel_topic, self._on_cmd_vel, 20)
        self.create_subscription(Float32MultiArray, self._motor_power_topic, self._on_motor_power, 20)
