...
gnome-terminal -x  $SHELL -ic "ros2 run laser_filters scan_to_scan_filter_chain --ros-args --params-file scan_filter.yaml -r scan:=/scan3 -r scan_filtered:=/scan_filtered" # max_height=2 if too high ceiling points in scan. /scan3 -> /scan_filtered
