...
xterm -e bash -ic "cd /tmp; ros2 bag play bag_panda3 --topics /unilidar/cloud /unilidar/imu --remap /unilidar/cloud:=/unilidar/cloud_raw --clock -r 0.8; bash"&
...
xterm -e bash -ic  "ros2 run pointcloud_to_laserscan_logged pointcloud_to_laserscan_logged_node  --ros-args   --params-file pointcloud_to_laserscan_unitree_logged.yaml   -r cloud_in:=/unilidar/cloud   -r scan:=/scan"&
