...
gnome-terminal -x  $SHELL -ic "cd ~/; ros2 bag play bag_panda1 --topics /unilidar/cloud /unilidar/imu --remap /unilidar/cloud:=/unilidar/cloud_raw --clock -r 0.2; bash"
...
gnome-terminal -x  $SHELL -ic "ros2 run pointcloud_to_laserscan pointcloud_to_laserscan_node  --ros-args   --params-file pointcloud_to_laserscan_unitree.yaml   -r cloud_in:=/unilidar/cloud   -r scan:=/scan"
