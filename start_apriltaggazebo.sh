...
gnome-terminal -x  $SHELL -ic "conda deactivate; ros2 launch fiducial_tb3_gazebo_demo sim_mapping_anchor.launch.py use_sim_time:=true;bash"
...
gnome-terminal -x  $SHELL -ic "rviz2 --ros-args -p use_sim_time:=true"
